...
class HADiscoveryPublisher:
    ...
    def _core_messages(self) -> list[DiscoveryMessage]:
        ...
        core_entities: list[tuple[str, str, dict[str, Any]]] = [
            ...
            ("control_doorbell_only_mode", "switch", {
                "name": "Synthia Vision Doorbell Only Mode",
                "icon": "mdi:doorbell-video",
                "state_topic": self._core_topic("control.doorbell_only_mode", "control/doorbell_only_mode"),
                "command_topic": self._core_topic("control.doorbell_only_mode_set", "control/doorbell_only_mode/set"),
                "payload_on": "ON",
                "payload_off": "OFF",
                "state_on": "ON",
                "state_off": "OFF",
            }),
            ("control_high_precision_mode", "switch", {
                "name": "Synthia Vision High Precision Mode",
                "icon": "mdi:target",
                "state_topic": self._core_topic("control.high_precision_mode", "control/high_precision_mode"),
                "command_topic": self._core_topic("control.high_precision_mode_set", "control/high_precision_mode/set"),
                "payload_on": "ON",
                "payload_off": "OFF",
                "state_on": "ON",
                "state_off": "OFF",
